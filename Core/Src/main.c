...
//			 breathsw = 1;
//			 HAL_GPIO_WritePin(C13_GPIO_Port,C13_Pin,GPIO_PIN_SET);
//			 CDC_Transmit_FS(aShow,sprintf((char *)aShow, "Short Press 短按\r\n"));
//			 HAL_Delay(50);
//			  
...
//			  breathsw = 0;
//			  HAL_GPIO_WritePin(C13_GPIO_Port,C13_Pin,GPIO_PIN_RESET);
//			  CDC_Transmit_FS(aShow,sprintf((char *)aShow, "Double Press 双击\r\n"));
//		  }
//		  else if(key_value == KEY0_LONG)
//		  {
//			  breathsw = 1;
//			  CDC_Transmit_FS(aShow,sprintf((char *)aShow, "Long Press 长按\r\n"));
//		  }
//	  }
  }
  /* USER CODE END 3 */
